...
analyses = options.analyses if options.analyses else ["phiRecmeson", "rhoRecmeson", "h2rhoRecmeson", "h2phiRecmeson", "h2rho", "h2phi"]
...
analyses_print = ["h2phiRecmeson", "h2rhoRecmeson", "h2rho", "h2phi"]
