...
class ScTrackerToOrbitFlatTable : public edm::global::EDProducer<> {
public:
  // constructor and destructor
  explicit ScTrackerToOrbitFlatTable(const edm::ParameterSet&);
  ~ScTrackerToOrbitFlatTable() override {};
...
ScTrackerToOrbitFlatTable::ScTrackerToOrbitFlatTable(const edm::ParameterSet& iConfig)
...
void ScTrackerToOrbitFlatTable::produce(edm::StreamID, edm::Event& iEvent, edm::EventSetup const&) const {
...
void ScTrackerToOrbitFlatTable::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(ScTrackerToOrbitFlatTable);
