...
namespace HTDebugger {
    void dumpTracks(const std::string &name, const std::vector<reco::Track> & tracks, const TrackingGeometry *geom=0, const TrackerTopology *topo=0) ;
    ...
    bool twoHitsOnSameTrack(const TrackingRecHit *hit1, const TrackingRecHit *hit2);
    ...
    const reco::Track * matchCandidate(const Trajectory & hits) ;
