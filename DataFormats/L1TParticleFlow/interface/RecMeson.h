...
namespace l1Scouting {
  ...
  public:
    RecMeson() {}
    RecMeson(float pt, float eta, float phi, float mass, int charge, int pdgId, float isoDR0p25, std::array<double, N>& daughterMasses, std::array<unsigned int, N>& daughterIds)
